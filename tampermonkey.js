...
// How to use: When you will enable this script in Tampermonkey and you visit any game page in the top bar there should be green colored button that says "Join". When you click the button a prompt asks you for the JobID. When you enter the JobID and press OK it will join you to the server.
